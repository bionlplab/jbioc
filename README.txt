...
lib/
  Contains bioc.jar. For full effectiveness, several other libraries
  need to be downloaded to this directory. Details below.
scripts/
...
BioC. The shell scripts assume these jar files are placed in the lib
subdirectory.

stax-utils.jar          https://java.net/projects/stax-utils/pages/Home

Woodstox StAX XML parser
stax2-api-3.1.1.jar     http://woodstox.codehaus.org/
woodstox-core-asl-4.1.4.jar

junit-4.11.jar           http://junit.org/
hamcrest-core-1.3.jar    https://code.google.com/p/hamcrest/
xmlunit-1.4.jar          http://xmlunit.sourceforge.net/

http://biolemmatizer.sourceforge.net/
BioLemmatizer.jar -> biolemmatizer-core-1.1-jar-with-dependencies.jar
